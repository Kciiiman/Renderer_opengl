...
int main() {
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(RenderWindow), &RenderWindow, GL_STATIC_DRAW);
    ...
    glFramebufferRenderbuffer(GL_FRAMEBUFFER, GL_DEPTH_STENCIL_ATTACHMENT, GL_RENDERBUFFER, rbo);   //绑定渲染缓冲
